...
//    protected Caixa caixa = new Caixa();
    ...
    protected Bugs armas0 = new Bugs();
    protected Bugs armas1 = new Bugs();
    protected Bugs armas2 = new Bugs();
...
//            new Thread(caixa).start();
  ...
  //-----------------------------------------------------SE HEROI TROMBAR NO CACTO -------------------------SE HEROI TROMBAR NO CACTO
    public void colisaoHeroiCacto(){
        if (verificaColisao(heroi.getlHeroi(), inimigo0.getlInimigo(), false) ||
                ...
                verificaColisao(heroi.getlHeroi(), inimigo8.getlInimigo(), false)){
            heroi.matarDino();
  ...
  //-----------------------------------------------------SE CACTO LEVAR UM TIRO -------------------------------SE CACTO LEVAR UM TIRO
    ...
    public void colisaoInimigoTiro(){
        ...
        // tiro 0
        if (verificaColisao(armas0.getlTiro(), inimigo0.getlInimigo(), true)){
            inimigo0.matarInimigoPorTiro();
            armas0.pararPedra();
        }
        if (verificaColisao(armas0.getlTiro(), inimigo1.getlInimigo(), true)) {
            inimigo1.matarInimigoPorTiro();
            armas0.pararPedra();
        }
        if (verificaColisao(armas0.getlTiro(), inimigo2.getlInimigo(), true)) {
            inimigo2.matarInimigoPorTiro();
            armas0.pararPedra();
        }
        if (verificaColisao(armas0.getlTiro(), inimigo3.getlInimigo(), true)) {
            inimigo3.matarInimigoPorTiro();
            armas0.pararPedra();
        }
        if (verificaColisao(armas0.getlTiro(), inimigo4.getlInimigo(), true)) {
            inimigo4.matarInimigoPorTiro();
            armas0.pararPedra();
        }
        if (verificaColisao(armas0.getlTiro(), inimigo5.getlInimigo(), true)) {
            inimigo5.matarInimigoPorTiro();
            armas0.pararPedra();
        }
        if (verificaColisao(armas0.getlTiro(), inimigo6.getlInimigo(), true)) {
            inimigo6.matarInimigoPorTiro();
            armas0.pararPedra();
        }
        if (verificaColisao(armas0.getlTiro(), inimigo7.getlInimigo(), true)) {
            inimigo7.matarInimigoPorTiro();
            armas0.pararPedra();
        }
        if (verificaColisao(armas0.getlTiro(), inimigo8.getlInimigo(), true)) {
            inimigo8.matarInimigoPorTiro();
            armas0.pararPedra();
        }
   
        // Tiro 2
        if (verificaColisao(armas1.getlTiro(), inimigo0.getlInimigo(), true)) {
            inimigo0.matarInimigoPorTiro();
            armas1.pararPedra();
        }
        ...
        if (verificaColisao(armas1.getlTiro(), inimigo3.getlInimigo(), true)) {
            inimigo3.matarInimigoPorTiro();
            armas1.pararPedra();
        }
        if (verificaColisao(armas1.getlTiro(), inimigo4.getlInimigo(), true)) {
            inimigo4.matarInimigoPorTiro();
            armas1.pararPedra();
        }
        if (verificaColisao(armas1.getlTiro(), inimigo5.getlInimigo(), true)) {
            inimigo5.matarInimigoPorTiro();
            armas1.pararPedra();
        }
        if (verificaColisao(armas1.getlTiro(), inimigo6.getlInimigo(), true)) {
            inimigo6.matarInimigoPorTiro();
            armas1.pararPedra();
        }
        if (verificaColisao(armas1.getlTiro(), inimigo7.getlInimigo(), true)) {
            inimigo7.matarInimigoPorTiro();
            armas1.pararPedra();
        }
        if (verificaColisao(armas1.getlTiro(), inimigo8.getlInimigo(), true)) {
            inimigo8.matarInimigoPorTiro();
            armas1.pararPedra();
        }
        
        // tiro 3
        if (verificaColisao(armas2.getlTiro(), inimigo0.getlInimigo(), true)) {
            inimigo0.matarInimigoPorTiro();
            armas2.pararPedra();
        }
        if (verificaColisao(armas2.getlTiro(), inimigo1.getlInimigo(), true)) {
            inimigo1.matarInimigoPorTiro();
            armas2.pararPedra();
        }
        if (verificaColisao(armas2.getlTiro(), inimigo2.getlInimigo(), true)) {
            inimigo2.matarInimigoPorTiro();
            armas2.pararPedra();
        }
        if (verificaColisao(armas2.getlTiro(), inimigo3.getlInimigo(), true)) {
            inimigo3.matarInimigoPorTiro();
            armas2.pararPedra();
        }
        if (verificaColisao(armas2.getlTiro(), inimigo4.getlInimigo(), true)) {
            inimigo4.matarInimigoPorTiro();
            armas2.pararPedra();
        }
        if (verificaColisao(armas2.getlTiro(), inimigo5.getlInimigo(), true)) {
            inimigo5.matarInimigoPorTiro();
            armas2.pararPedra();
        }
        if (verificaColisao(armas2.getlTiro(), inimigo6.getlInimigo(), true)) {
            inimigo6.matarInimigoPorTiro();
            armas2.pararPedra();
        }
        if (verificaColisao(armas2.getlTiro(), inimigo7.getlInimigo(), true)) {
            inimigo7.matarInimigoPorTiro();
            armas2.pararPedra();
        }
        if (verificaColisao(armas2.getlTiro(), inimigo8.getlInimigo(), true)) {
            inimigo8.matarInimigoPorTiro();
            armas2.pararPedra();
        }
    }
